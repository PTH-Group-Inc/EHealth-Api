...
import { UserDetail, UserQueryFilter, PaginatedUsers, CreateUserInput, UpdateUserByAdminInput } from '../models/user.model';
...
export class UserRepository {
     ...
     */
    static async createUser(data: CreateUserInput & { hashedPassword?: string }): Promise<string> {
     ...
     */
    static async lockUser(userId: string): Promise<boolean> {
        const query = `
            UPDATE users
