...
export class DispensingController {
    ...
    static dispense = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    static getByPrescription = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
            const prescriptionId = req.params.prescriptionId as string;
    ...
    static getInventory = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    ...
    static getByPharmacist = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
