...
export const generateQR = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const getOrdersByInvoice = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const manualVerify = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    const order = await PaymentGatewayService.manualVerify(String(req.params.orderId));
    res.json({ success: true, data: order });
});

/** Xem cấu hình gateway */
export const getGatewayConfig = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    const config = await PaymentGatewayService.getGatewayConfig();
    res.json({ success: true, data: config });
});

/** Cập nhật cấu hình gateway */
export const updateGatewayConfig = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const testGatewayConnection = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const getOnlineHistory = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const getOnlineStats = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
