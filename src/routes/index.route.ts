...
import { aiHealthChatRoutes } from './AI Health/ai-health-chat.routes';
import { aiRagRoutes } from './AI Health/ai-rag.routes';
...
export const initRoutes = (app: Express) => {
    ...
    // ═══ MODULE 7: TRÍ TUỆ NHÂN TẠO Y TẾ (AI Health Agent) ═══
