...
const authorizeRoles_middleware_1 = require("../middleware/authorizeRoles.middleware");
const userRoutes = (0, express_1.Router)();
userRoutes.use(verifyAccessToken_middleware_1.verifyAccessToken);
userRoutes.use((0, authorizeRoles_middleware_1.authorizeRoles)('ADMIN', 'SYSTEM'));
/**
 * @swagger
 * tags:
 ...
 *         description: Lấy danh sách thành công
 */
userRoutes.get('/search', user_controller_1.UserController.searchUsers);
/**
 * @swagger
 * /api/users/{userId}:
 *   get:
 ...
 */
userRoutes.get('/:userId', user_controller_1.UserController.getUserById);
/**
 * @swagger
 * /api/users/{userId}:
 *   put:
...
userRoutes.patch('/:userId', user_controller_1.UserController.updateUser);
/**
 * @swagger
 * /api/users/{userId}:
 *   delete:
 ...
 *         description: Không tìm thấy người dùng
 */
userRoutes.patch('/:userId/lock', user_controller_1.UserController.lockUser);
/**
 * @swagger
 ...
 *         description: Không tìm thấy người dùng
 */
userRoutes.patch('/:userId/unlock', user_controller_1.UserController.unlockUser);
